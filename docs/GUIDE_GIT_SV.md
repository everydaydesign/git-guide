...
1. Gå till mallrepot för ert projekt — [website](https://github.com/everydaydesign/website) för HTML/CSS, eller [web-app](https://github.com/everydaydesign/web-app) för PHP/MySQL
